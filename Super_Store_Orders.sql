...
SELECT 
	Category,
	ROUND(SUM(Sales),0) as Total_Sales,
	100*SUM(Sales)/(SELECT SUM(Sales) FROM Project_1..Orders) as Percentage_of_Total_Sales
FROM Project_1..Orders
GROUP BY Category
ORDER BY Total_Sales DESC;
...
SELECT 
	State,
	ROUND(SUM(Sales),0) as Total_Sales,
	SUM(Sales)/(SELECT SUM(Sales) FROM Project_1..Orders) as Percentage_of_Total_Sales
FROM Project_1..Orders
GROUP BY State
ORDER BY Total_Sales DESC
OFFSET 0 ROWS FETCH FIRST 3 ROWS ONLY;
